        ...
        <div className="flex flex-col items-center justify-center p-4 -mt-16">
          ...
          <div className="w-full p-2 mt-4 rounded-lg">
            <div className="flex flex-wrap items-center justify-between text-sm text-gray-600 ">
              ...
              <div>
                <button className="bg-blue-500 px-10 py-1 rounded-lg text-white cursor-pointer hover:bg-blue-200 block mb-1">
                  Update Profile
                </button>
                <button className="bg-blue-500 px-7 py-1 rounded-lg text-white cursor-pointer hover:bg-blue-200">
                  Change Password
                </button>
              </div>
            </div>
